...
@Table(name="AUTHORIZED_EMPLOYEE")
public class Authorized_Employee {
    ...
    public Authorized_Employee(int EmployeeID, String EmployeeType, String Employee_FName, String Employee_LName, String Address, String Email,  String Phone){
    ...
    public String toString(){
        return "emp : "+ getEmployeeID() + ", type : "+getEmployeeType() ;
    }
}